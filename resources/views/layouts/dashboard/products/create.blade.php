...
@section('content')
    ...
    <div class="max-w-6xl mx-auto mt-24">
        <h1 class="text-center text-2xl font-semibold">Dashboard Create Product</h1>
        <div class="mx-56 rounded-xl shadow-xl">
            <div class="p-7">
                ...
                <div class="flex justify-end">
                    <a href="">
                        <button class="bg-emerald-500 px-7 py-2 rounded-full mt-5 font-semibold text-white">CREATE</button>
                    </a>
                </div>
            </div>
        </div>
